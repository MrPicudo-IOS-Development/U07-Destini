...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoise: String) {
        ...
        // A partir de la "historia actual", vamos a comparar la variable userChoice que viene definida por el current.senderTitle! del botón que se presionó.
